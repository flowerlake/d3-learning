...
d3.select("#years_1947_girls").on("click", function () {
    changeYears(1880, 1947, "girls")
});
d3.select("#years_1965_boys").on("click", function () {
    changeYears(1880, 1965, "boys")
});
d3.select("#Christopher").on("click", function () {
    changeName("Christopher", "boys")
});
d3.select("#Jason").on("click", function () {
    changeName("Jason", "boys")
});
d3.select("#years_2005_boys").on("click", function () {
    changeYears(2005, 2014, "boys")
});

d3.select("#Mary").on("click", function () {
    changeName("Mary", "girls")
});
d3.select("#Linda").on("click", function () {
    changeName("Linda", "girls")
});
d3.select("#years_1947_1952_girls").on("click", function () {
    changeYears(1945, 1954, "girls")
});

d3.select("#John").on("click", function () {
    changeName("John", "boys")
});
d3.select("#Michael").on("click", function () {
    changeName("Michael", "boys")
});
d3.select("#James").on("click", function () {
    changeName("James", "boys")
});
d3.select("#Robert").on("click", function () {
    changeName("Robert", "boys")
});

d3.select("#Ethel").on("click", function () {
    changeName("Ethel", "girls")
});
d3.select("#Daniel").on("click", function () {
    changeName("Daniel", "boys")
});

d3.select("#Elizabeth").on("click", function () {
    changeName("Elizabeth", "girls")
});
d3.select("#Emma").on("click", function () {
    changeName("Emma", "girls")
});
d3.select("#William").on("click", function () {
    changeName("William", "boys")
});
d3.select("#Joseph").on("click", function () {
    changeName("Joseph", "boys")
});

d3.select("#Mary2").on("click", function () {
    changeName("Mary", "girls")
});
d3.select("#Linda2").on("click", function () {
    changeName("Linda", "girls")
});
d3.select("#John2").on("click", function () {
    changeName("John", "boys")
});